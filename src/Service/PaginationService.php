...
class PaginationService
{
    ...
    public function getPages(): int
    {
        if (empty($this->entityClass)) {
            throw new \Exception("Vous n'avez pas spécifié l'entité sur laquelle doit se faire la pagination ! Utilisez la méthode setEntityClass() de votre objet PaginationService.", 1);
        }
